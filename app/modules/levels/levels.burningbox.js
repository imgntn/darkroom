...
// intermediate scene.
	...
	// this.planeGeometry2 = new THREE.CubeGeometry( 290, 100, 1, 1 );
	// this.planeMaterial2 = new THREE.MeshBasicMaterial( { color: 0x000000 } );
	// this.plane2 = new THREE.Mesh( this.planeGeometry2, this.planeMaterial2 );
	// this.plane2.position.set(0,100,499);
		}
